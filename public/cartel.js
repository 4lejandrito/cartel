...
define([
    ...
    /**********************************************************
     * Each byte represents a column discarding the first bit
     * 
    ...
    var alphabet = {
        ...
        get: function(text) {
            ...
            for( var i = 0; i < text.length; i++)
                letters.push(font[text.charCodeAt(i) - 32] || font[127 - 32]);
            return letters;
        }
    };
    ...
    *************************************/
    ...
    return Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.options.rows = alphabet.height;            
            this.leds = [];
        ...
        print: function(text) {            
            this.letters = alphabet.get(this.text = text);
            this.off();
